...
+ (NSArray<SGVideoItem *> *)videoItems
{
  ...
  NSURL *bigBuckBunny = [[NSBundle mainBundle] URLForResource:@"big-buck-bunny_trailer" withExtension:@"webm"];
  NSURL *elephantsDream = [[NSBundle mainBundle] URLForResource:@"elephants-dream" withExtension:@"webm"];
  ...
  {
    SGVideoItem *item = [[SGVideoItem alloc] init];
    item.name = @"Big Buck Bunny";
    item.asset = [SGAsset assetWithURL:bigBuckBunny];
    item.displayMode = SGDisplayModePlane;
    [items addObject:item];
  }
  {
    SGVideoItem *item = [[SGVideoItem alloc] init];
    item.name = @"Elephants Dream";
    item.asset = [SGAsset assetWithURL:elephantsDream];
    item.displayMode = SGDisplayModePlane;
    [items addObject:item];
  }
  return items;
